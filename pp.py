...
# --- TrustOTP CONFIG ---
access = "c769d7a5cbb84208882d649ae52385d6"
service = "ihrg"
base_url = "https://readyacc.store/api/api.php"
...
def background_worker(user_id):
    ...
    user_data["balance"] = safe_get({"access": access, "type": "getAvailableBalance"}, user_data)
